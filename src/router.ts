 ...
 *           example: Monitor Curvo de 49 puldagas
 *         price: 
 *           type: number
 ...
 *      tags:
 *          - Products
 *      description: Returns a new record in the databse
 *      requestBody:
 *          required: true
 *          content: 
 *              application/json:
...
router.post("/",
    body("name").notEmpty().withMessage("El nombre de Producto no puede estar vacío"),
    body("price")
